...
$rs=mysql_query("select * from mst_question where test_id=$tid ORDER BY RAND() Limit 1" ,$cn) or die(mysql_error());
...
{	
		if (!isset($ans) and ($submit=='Next Question' or $submit=='Get Result')) {
